...
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), H = Object.assign, g = Array.isArray, xe = (e) => Z(e) === "[object Map]", Ie = (e) => Z(e) === "[object Set]", C = (e) => typeof e == "function", b = (e) => typeof e == "string", X = (e) => typeof e == "symbol", E = (e) => e !== null && typeof e == "object", le = Object.prototype.toString, Z = (e) => le.call(e), Fe = (e) => Z(e) === "[object Object]";
let re;
...
function Pe(e) {
  const t = {};
  return e.replace(De, "").split(Te).forEach((n) => {
    if (n) {
      const o = n.split($e);
...
function T(e, ...t) {
  if (B) return;
  B = !0;
  const n = O.length ? O[O.length - 1].component : null, o = n && n.appContext.config.warnHandler, s = je();
  if (o)
    ne(
      o,
      n,
...
function He({ vnode: e, recurseCount: t }) {
  ...
  return e.props ? [s, ...Ue(e.props), r] : [s + r];
}
function Ue(e) {
...
function qe(e, t, n, o = !0, s = !1) {
  if (a.NODE_ENV !== "production") {
    const r = de[t];
    if (n && Me(n), T(`Unhandled error${r ? ` during execution of ${r}` : ""}`), n && Ae(), o)
      throw e;
    console.error(e);
  } else {
    if (s)
...
function Ke(e) {
  if (!(e.flags & 1)) {
    const t = $(e), n = m[m.length - 1];
    !n || // fast path when the job id is larger than the tail
    !(e.flags & 2) && t >= $(n) ? m.push(e) : m.splice(We(t), 0, e), e.flags |= 1, me();
  }
}
function me() {
  Q || (Q = Je.then(ge));
...
a.NODE_ENV !== "production" && (U().__VUE_HMR_RUNTIME__ = {
  createRecord: K(Ge),
  rerender: K(Qe),
  reload: K(Xe)
});
...
const nt = {}, ye = (e) => Object.getPrototypeOf(e) === nt, ot = (e) => e.__isSuspense, Se = Symbol.for("v-fgt"), rt = Symbol.for("v-txt"), st = Symbol.for("v-cmt"), D = [];
let h = null;
function it(e = !1) {
  D.push(h = e ? null : []);
}
function lt() {
  D.pop(), h = D[D.length - 1] || null;
}
function ct(e) {
...
const at = (...e) => Ee(
  ...
  ref_key: t,
  ref_for: n
}) => (typeof e == "number" && (e = "" + e), e != null ? b(e) || te(e) || C(e) ? { i: j, r: e, k: t, f: !!n } : e : null);
...
function Ee(e, t = null, n = null, o = 0, s = null, r = !1) {
  ...
  if (ke(e) && (e = e.__vccOpts), t) {
    ...
    c && !b(c) && (t.class = ee(c)), E(u) && (G(u) && !g(u) && (u = H({}, u)), t.style = v(u));
  }
...
function z(e, t, n = !1, o = !1) {
  const { props: s, ref: r, patchFlag: l, children: c, transition: u } = e, _ = t ? mt(s || {}, t) : s, S = {
    ...
    ref: t && t.ref ? (
      ...
      n && r ? g(r) ? r.concat(P(t)) : [r, P(t)] : P(t)
    ) : r,
    scopeId: e.scopeId,
...
function oe(e, t) {
  ...
  if (t == null)
    ...
    if (o & 65) {
      ...
      n = 32, !t._ && !ye(t) && (t._ctx = j);
  else C(t) ? (t = { default: t, _ctx: j }, n = 32) : (t = String(t), o & 64 ? (n = 16, t = [F(t)]) : n = 8);
...
function wt(e, t, n, o, s, r) {
  return it(), ut("div", bt, [
    ...
    p("ul", null, [
      p("li", null, [
        t[0] || (t[0] = p("strong", null, "Código del módulo:", -1)),
        F(" " + I(n.moduleId), 1)
      ]),
      p("li", null, [
        t[1] || (t[1] = p("strong", null, "ID de objeto externo:", -1)),
        F(" " + I(n.externalId), 1)
      ]),
      p("li", null, [
        t[2] || (t[2] = p("strong", null, "Modo:", -1)),
        F(" " + I(n.mode), 1)
      ]),
      p("li", null, [
        t[3] || (t[3] = p("strong", null, "Token de usuario:", -1)),
        F(" " + I(n.userToken), 1)
      ])
    ])
  ]);
}
const Ct = /* @__PURE__ */ Nt(Et, [["render", wt], ["__scopeId", "data-v-33f584dc"]]);
export {
  Ct as default
};
