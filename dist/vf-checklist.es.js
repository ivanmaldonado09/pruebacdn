import { createElementBlock as E, openBlock as g, createElementVNode as m, withDirectives as j, toDisplayString as T, Fragment as P, renderList as I, vModelSelect as wt, createTextVNode as be, resolveComponent as H, createVNode as Te, vModelText as W, normalizeClass as gt, createCommentVNode as B, createBlock as we } from "vue";
function He(e, t) {
  return function() {
    return e.apply(t, arguments);
  };
}
const { toString: Et } = Object.prototype, { getPrototypeOf: Oe } = Object, { iterator: le, toStringTag: Ve } = Symbol, ce = /* @__PURE__ */ ((e) => (t) => {
  const n = Et.call(t);
...
const _t = ue("string"), L = ue("function"), Je = ue("number"), X = (e) => e !== null && typeof e == "object", Rt = (e) => e === !0 || e === !1, ne = (e) => {
  if (ce(e) !== "object")
    return !1;
  const t = Oe(e);
...
}, Tt = k("Date"), Ot = k("File"), Ct = k("Blob"), xt = k("FileList"), Lt = (e) => X(e) && L(e.pipe), Nt = (e) => {
  let t;
...
}, kt = k("URLSearchParams"), [Ft, Ut, vt, Pt] = ["ReadableStream", "Request", "Response", "Headers"].map(k), It = (e) => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const Dt = (e, t, n, { allOwnKeys: r } = {}) => (Y(t, (s, o) => {
  n && L(s) ? e[o] = He(s, n) : e[o] = s;
}, { allOwnKeys: r }), e), Bt = (e) => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e), qt = (e, t, n, r) => {
  ...
  for (; t-- > 0; )
    n[t] = e[t];
  return n;
}, Ht = /* @__PURE__ */ ((e) => (t) => e && t instanceof e)(typeof Uint8Array < "u" && Oe(Uint8Array)), Vt = (e, t) => {
...
), Ne = (({ hasOwnProperty: e }) => (t, n) => e.call(t, n))(Object.prototype), Wt = k("RegExp"), Ke = (e, t) => {
...
const en = (e) => {
  ...
  return n(e, 0);
}, tn = k("AsyncFunction"), nn = (e) => e && (X(e) || L(e)) && L(e.then) && L(e.catch), Qe = ((e, t) => e ? setImmediate : t ? ((n, r) => (q.addEventListener("message", ({ source: s, data: o }) => {
  ...
  L(q.postMessage)
), rn = typeof queueMicrotask < "u" ? queueMicrotask.bind(q) : typeof process < "u" && process.nextTick || Qe, sn = (e) => e != null && L(e[le]), a = {
  isArray: V,
  isArrayBuffer: ze,
  isBuffer: Q,
  isFormData: Nt,
...
function de(e, t, n) {
  ...
  function u(h, b, p) {
    ...
    if (h && !p && typeof h == "object") {
      ...
      else if (a.isArray(h) && an(h) || (a.isFileList(h) || a.endsWith(b, "[]")) && (_ = a.toArray(h)))
...
}, xe = typeof window < "u" && typeof document < "u", Se = typeof navigator == "object" && navigator || void 0, pn = xe && (!Se || ["ReactNative", "NativeScript", "NS"].indexOf(Se.product) < 0), mn = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", yn = xe && window.location.href || "http://localhost", bn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: xe,
...
function rt(e) {
  function t(n, r, s, o) {
    ...
    return i = !i && a.isArray(s) ? s.length : i, d ? (a.hasOwnProp(s, i) ? s[i] = [s[i], r] : s[i] = r, !l) : ((!s[i] || !a.isObject(s[i])) && (s[i] = []), t(n, r, s[i], o) && a.isArray(s[i]) && (s[i] = En(s[i])), !l);
  }
...
}, Ie = (e) => (...t) => a.asap(() => e(...t)), kn = C.hasStandardBrowserEnv ? /* @__PURE__ */ ((e, t) => (n) => (n = new URL(n, C.origin), e.protocol === n.protocol && e.host === n.host && (t || e.port === n.port)))(
  new URL(C.origin),
...
const at = (e) => {
  ...
  if (C.hasStandardBrowserEnv && (r && a.isFunction(r) && (r = r(t)), r || r !== !1 && kn(t.url))) {
    const c = s && o && Fn.read(o);
    c && i.set(s, c);
  }
  return t;
}, Pn = typeof XMLHttpRequest < "u", In = Pn && function(e) {
...
}, fe = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", lt = fe && typeof ReadableStream == "function", $n = fe && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((e) => (t) => e.encode(t))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), ct = (e, ...t) => {
  try {
    return !!e(...t);
  } catch {
    return !1;
...
const Hn = async (e) => {
  ...
  let R = Dn([s, o && o.toAbortSignal()], i), h;
  const b = R && R.unsubscribe && (() => {
    R.unsubscribe();
  });
  let p;
  try {
    if (d && jn && n !== "get" && n !== "head" && (p = await Vn(u, r)) !== 0) {
      let x = new Request(t, {
        method: "POST",
        body: r,
        duplex: "half"
...
const Me = (e) => `- ${e}`, Jn = (e) => a.isFunction(e) || e === null || e === !1, ut = {
  getAdapter: (e) => {
    ...
    for (let o = 0; o < t; o++) {
      n = e[o];
      let i;
      if (r = n, !Jn(n) && (r = Re[(i = String(n)).toLowerCase()], r === void 0))
...
const {
  ...
  getAdapter: ys,
  mergeConfig: bs
} = S, Xn = "https://api.checklist.dev.grava.io/api", ae = S.create({
  baseURL: Xn
});
function Yn(e) {
...
function ar(e, t, n, r, s, o) {
  return g(), E("div", tr, [
    m("h3", nr, T(e.translateTerm("SELECT_FORM_TITLE")), 1),
    m("label", rr, T(e.translateTerm("SELECT_FORM_LABEL")), 1),
    j(m("select", {
      "onUpdate:modelValue": t[0] || (t[0] = (i) => s.selectedId = i),
      class: "form-select"
    }, [
      m("option", sr, T(e.translateTerm("SELECT_FORM_OPTION_PLACEHOLDER")), 1),
...
const mt = /* @__PURE__ */ ee(er, [["render", ar], ["__scopeId", "data-v-6a3747fb"]]), G = {
  initialize() {
...
}, cr = { class: "select-questions-multiple-option" }, ur = { class: "title-question" }, dr = { class: "container-checkbox" }, fr = { class: "checkbox-items-container" }, hr = ["for"], pr = ["id", "checked", "onChange"], mr = { class: "inputQuestionItem" }, yr = { class: "limit-characters multiple-questions" };
function br(e, t, n, r, s, o) {
  const i = H("translate");
  return g(), E("div", cr, [
    m("h4", ur, T(`${n.titleLabel} ${n.inputRequired ? "*" : ""}`), 1),
    m("div", dr, [
      m("div", fr, [
      ...
      m("div", mr, [
        ...
        m("span", yr, T(s.value ? s.value.length : 0) + " / 100 ", 1)
      ])
    ])
  ]);
}
const wr = /* @__PURE__ */ ee(lr, [["render", br]]), gr = {
...
}, Er = { class: "select-questions-unique-option" }, Sr = { class: "title-question" }, _r = { class: "container-checkbox" }, Rr = { class: "checkbox-items-container" }, Ar = ["id", "name", "checked", "onChange"], Tr = ["for"], Or = { class: "inputQuestionItem" }, Cr = { class: "limit-characters multiple-questions" };
function xr(e, t, n, r, s, o) {
  const i = H("translate");
  return g(), E("div", Er, [
    m("h4", Sr, T(`${n.titleLabel} ${n.inputRequired ? "*" : ""}`), 1),
    m("div", _r, [
      m("div", Rr, [
        (g(!0), E(P, null, I(n.options, (l) => (g(), E("div", {
          class: gt(n.options.length > 3 ? "flex-25" : "flex-33"),
          key: l.id
        }, [
          m("input", {
            id: "option-" + l.id,
          ...
          m("label", {
            for: "option-" + l.id
          }, T(n.iche2b ? `${l.key} - ${l.value}` : `${l.key}`), 9, Tr)
        ], 2))), 128))
      ]),
      m("div", Or, [
        m("label", null, [
...
}, Fr = { class: "form-card" }, Ur = { class: "form-header" }, vr = { class: "form-title" }, Pr = { class: "form-subtitle" }, Ir = { class: "section-title" }, Dr = { key: 0 }, Br = { key: 0 }, qr = ["onUpdate:modelValue"], Mr = {
  key: 2,
  class: "table-wrapper"
}, $r = { class: "input-table" }, jr = ["onUpdate:modelValue"], Hr = {
  key: 3,
  class: "textarea-wrapper"
}, Vr = { key: 0 }, zr = ["onUpdate:modelValue"], Jr = { class: "btn-save-wrapper" }, Gr = { class: "btn-save" };
function Wr(e, t, n, r, s, o) {
  const i = H("SelectQuestionsUnique"), l = H("SelectQuestionsMultipleOption");
  return g(), E("div", Fr, [
    m("div", Ur, [
      m("h3", vr, T(n.formData.name), 1),
      m("button", {
        class: "h5-img",
    ...
    m("p", Pr, T(e.translateTerm("GENERAL_PREFILL_FORM")), 1),
    (g(!0), E(P, null, I(o.orderedSections, (d) => (g(), E("div", {
      ...
      (g(!0), E(P, null, I(o.orderedInputs(d.inputs), (c) => (g(), E("div", {
        ...
        c.value === "TL" ? (g(), E("div", Dr, [
          m("label", null, [
            be(T(c.key) + " ", 1),
            c.required ? (g(), E("span", Br, "*")) : B("", !0)
          ]),
          j(m("input", {
        ...
        c.value === "TE" ? (g(), E("div", Hr, [
          m("label", null, [
            be(T(c.key) + " ", 1),
            c.required ? (g(), E("span", Vr, "*")) : B("", !0)
          ]),
          j(m("textarea", {
            "onUpdate:modelValue": (u) => s.answers[c.id] = u,
            class: "textarea"
    ...
    m("div", Jr, [
      m("button", Gr, T(e.translateTerm("GENERAL_SAVE")), 1)
    ])
  ]);
}
const bt = /* @__PURE__ */ ee(kr, [["render", Wr], ["__scopeId", "data-v-530b3596"]]), Kr = {
  name: "VfChecklist",
  components: { FormSelect: mt, FormRenderer: bt },
  props: {
...
const Yr = /* @__PURE__ */ ee(Kr, [["render", Xr], ["__scopeId", "data-v-b741bbac"]]), ws = {
  install(e) {
    e.component("VfChecklist", Yr), e.component("FormSelect", mt), e.component("FormRenderer", bt);
  }
};
export {
  bt as FormRenderer,
