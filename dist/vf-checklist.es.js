import { createElementBlock as g, openBlock as E, createElementVNode as m, withDirectives as V, toDisplayString as S, Fragment as U, renderList as B, vModelSelect as bt, createTextVNode as be, vModelText as J, normalizeClass as Et, resolveComponent as oe, createCommentVNode as q, createBlock as Ee, createVNode as gt } from "https://unpkg.com/vue@3/dist/vue.esm-browser.prod.js";
function $e(e, t) {
  return function() {
    return e.apply(t, arguments);
  };
}
const { toString: Rt } = Object.prototype, { getPrototypeOf: Te } = Object, { iterator: le, toStringTag: He } = Symbol, ce = /* @__PURE__ */ ((e) => (t) => {
  const n = Rt.call(t);
  return e[n] || (e[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), N = (e) => (e = e.toLowerCase(), (t) => ce(t) === e), ue = (e) => (t) => typeof t === e, { isArray: $ } = Array, G = ue("undefined");
function K(e) {
...
const _t = ue("string"), F = ue("function"), Je = ue("number"), Q = (e) => e !== null && typeof e == "object", At = (e) => e === !0 || e === !1, te = (e) => {
  if (ce(e) !== "object")
    return !1;
  const t = Te(e);
...
}, Tt = N("Date"), Ct = N("File"), Lt = N("Blob"), Ft = N("FileList"), xt = (e) => Q(e) && F(e.pipe), Nt = (e) => {
  let t;
...
}, kt = N("URLSearchParams"), [vt, Pt, Ut, Bt] = ["ReadableStream", "Request", "Response", "Headers"].map(N), Dt = (e) => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const qt = (e, t, n, { allOwnKeys: r } = {}) => (X(t, (s, i) => {
  ...
  for (; t-- > 0; )
    n[t] = e[t];
  return n;
}, Ht = /* @__PURE__ */ ((e) => (t) => e && t instanceof e)(typeof Uint8Array < "u" && Te(Uint8Array)), zt = (e, t) => {
  ...
  for (; (n = e.exec(t)) !== null; )
    r.push(n);
  return r;
}, Gt = N("HTMLFormElement"), Wt = (e) => e.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, r, s) {
    return r.toUpperCase() + s;
  }
), xe = (({ hasOwnProperty: e }) => (t, n) => e.call(t, n))(Object.prototype), Kt = N("RegExp"), Ke = (e, t) => {
...
const tn = (e) => {
  ...
  return n(e, 0);
}, nn = N("AsyncFunction"), rn = (e) => e && (Q(e) || F(e)) && F(e.then) && F(e.catch), Qe = ((e, t) => e ? setImmediate : t ? ((n, r) => (I.addEventListener("message", ({ source: s, data: i }) => {
  ...
  F(I.postMessage)
), sn = typeof queueMicrotask < "u" ? queueMicrotask.bind(I) : typeof process < "u" && process.nextTick || Qe, on = (e) => e != null && F(e[le]), a = {
  isArray: $,
  isArrayBuffer: ze,
  isBuffer: K,
  isFormData: Nt,
...
function de(e, t, n) {
  ...
  function u(h, w, p) {
    ...
    if (h && !p && typeof h == "object") {
      ...
      else if (a.isArray(h) && ln(h) || (a.isFileList(h) || a.endsWith(w, "[]")) && (R = a.toArray(h)))
        return w = Ye(w), R.forEach(function(T, v) {
          !(a.isUndefined(T) || T === null) && t.append(
            // eslint-disable-next-line no-nested-ternary
            o === !0 ? Ne([w], v, i) : o === null ? w : w + "[]",
            l(T)
          );
        }), !1;
    }
    return Re(h) ? !0 : (t.append(Ne(p, w, i), l(h)), !1);
  }
  const f = [], b = Object.assign(cn, {
    defaultVisitor: u,
    convertValue: l,
    isVisitable: Re
  });
...
}, dn = typeof URLSearchParams < "u" ? URLSearchParams : Ce, fn = typeof FormData < "u" ? FormData : null, hn = typeof Blob < "u" ? Blob : null, pn = {
  isBrowser: !0,
  classes: {
    URLSearchParams: dn,
    FormData: fn,
...
}, Le = typeof window < "u" && typeof document < "u", Se = typeof navigator == "object" && navigator || void 0, mn = Le && (!Se || ["ReactNative", "NativeScript", "NS"].indexOf(Se.product) < 0), yn = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", wn = Le && window.location.href || "http://localhost", bn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: Le,
...
}, fe = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", lt = fe && typeof ReadableStream == "function", Vn = fe && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((e) => (t) => e.encode(t))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), ct = (e, ...t) => {
  try {
    return !!e(...t);
  } catch {
    return !1;
...
const Hn = async (e) => {
  ...
  let A = qn([s, i && i.toAbortSignal()], o), h;
  const w = A && A.unsubscribe && (() => {
    A.unsubscribe();
  });
  let p;
  try {
    if (d && $n && n !== "get" && n !== "head" && (p = await zn(u, r)) !== 0) {
      let L = new Request(t, {
        method: "POST",
        body: r,
        duplex: "half"
...
const Me = (e) => `- ${e}`, Gn = (e) => a.isFunction(e) || e === null || e === !1, ut = {
  getAdapter: (e) => {
    e = a.isArray(e) ? e : [e];
    const { length: t } = e;
    let n, r;
    ...
    for (let i = 0; i < t; i++) {
      n = e[i];
      let o;
      if (r = n, !Gn(n) && (r = Ae[(o = String(n)).toLowerCase()], r === void 0))
...
const {
  ...
  getAdapter: bs,
  mergeConfig: Es
} = _, Zn = "https://api.checklist.dev.grava.io/api", W = _.create({
  baseURL: Zn
});
function Yn(e) {
...
}, nr = { class: "form-selector-card" }, rr = { class: "form-title" }, sr = { class: "form-label" }, or = {
  value: "",
  disabled: ""
}, ir = ["value"], ar = { class: "btn-add-container" };
function lr(e, t, n, r, s, i) {
  return E(), g("div", nr, [
    m("h3", rr, S(e.translateTerm("SELECT_FORM_TITLE")), 1),
    m("label", sr, S(e.translateTerm("SELECT_FORM_LABEL")), 1),
    V(m("select", {
      "onUpdate:modelValue": t[0] || (t[0] = (o) => s.selectedId = o),
      class: "form-select"
    }, [
      m("option", or, S(e.translateTerm("SELECT_FORM_OPTION_PLACEHOLDER")), 1),
...
const cr = /* @__PURE__ */ Y(tr, [["render", lr], ["__scopeId", "data-v-6a3747fb"]]), ur = {
...
}, dr = { class: "select-questions-multiple-option" }, fr = { class: "title-question" }, hr = { class: "container-checkbox" }, pr = { class: "checkbox-items-container" }, mr = ["for"], yr = ["id", "checked", "onChange"], wr = { class: "inputQuestionItem" }, br = { class: "limit-characters multiple-questions" };
function Er(e, t, n, r, s, i) {
  return E(), g("div", dr, [
    m("h4", fr, S(`${n.titleLabel} ${n.inputRequired ? "*" : ""}`), 1),
    m("div", hr, [
      m("div", pr, [
      ...
      m("div", wr, [
        ...
        m("span", br, S(s.value ? s.value.length : 0) + " / 100 ", 1)
      ])
    ])
  ]);
}
const gr = /* @__PURE__ */ Y(ur, [["render", Er]]), Rr = {
...
}, Sr = { class: "select-questions-unique-option" }, _r = { class: "title-question" }, Ar = { class: "container-checkbox" }, Or = { class: "checkbox-items-container" }, Tr = ["id", "name", "checked", "onChange"], Cr = ["for"], Lr = { class: "inputQuestionItem" }, Fr = { class: "limit-characters multiple-questions" };
function xr(e, t, n, r, s, i) {
  return E(), g("div", Sr, [
    m("h4", _r, S(`${n.titleLabel} ${n.inputRequired ? "*" : ""}`), 1),
    m("div", Ar, [
      m("div", Or, [
        (E(!0), g(U, null, B(n.options, (o) => (E(), g("div", {
          class: Et(n.options.length > 3 ? "flex-25" : "flex-33"),
          key: o.id
        }, [
          m("input", {
            id: "option-" + o.id,
      ...
      m("div", Lr, [
        ...
        m("span", Fr, S(s.value ? s.value.length : 0) + " / 100 ", 1)
      ])
    ])
  ]);
}
const Nr = /* @__PURE__ */ Y(Rr, [["render", xr]]), kr = {
  name: "FormRenderer",
  components: {
    SelectQuestionsMultipleOption: gr,
    SelectQuestionsUnique: Nr
  },
  props: {
    formData: {
      type: Object,
...
}, vr = { class: "form-card" }, Pr = { class: "form-header" }, Ur = { class: "form-title" }, Br = { class: "form-subtitle" }, Dr = { class: "section-title" }, qr = { key: 0 }, Ir = { key: 0 }, Mr = ["onUpdate:modelValue"], jr = {
  key: 2,
  class: "table-wrapper"
}, Vr = { class: "input-table" }, $r = ["onUpdate:modelValue"], Hr = {
  key: 3,
  class: "textarea-wrapper"
}, zr = { key: 0 }, Jr = ["onUpdate:modelValue"], Gr = { class: "btn-save-wrapper" };
function Wr(e, t, n, r, s, i) {
  const o = oe("SelectQuestionsUnique"), c = oe("SelectQuestionsMultipleOption");
  return E(), g("div", vr, [
    m("div", Pr, [
      m("h3", Ur, S(n.formData.name), 1),
      m("button", {
        class: "h5-img",
    ...
    m("p", Br, S(e.translateTerm("GENERAL_PREFILL_FORM")), 1),
    (E(!0), g(U, null, B(i.orderedSections, (d) => (E(), g("div", {
      ...
      (E(!0), g(U, null, B(i.orderedInputs(d.inputs), (l) => (E(), g("div", {
        ...
        l.value === "TL" ? (E(), g("div", qr, [
          m("label", null, [
            be(S(l.key) + " ", 1),
            l.required ? (E(), g("span", Ir, "*")) : q("", !0)
          ]),
          V(m("input", {
        ...
        l.value === "TE" ? (E(), g("div", Hr, [
          m("label", null, [
            be(S(l.key) + " ", 1),
            l.required ? (E(), g("span", zr, "*")) : q("", !0)
          ]),
          V(m("textarea", {
            "onUpdate:modelValue": (u) => s.answers[l.id] = u,
            class: "textarea"
...
const Kr = /* @__PURE__ */ Y(kr, [["render", Wr]]), Qr = {
  name: "VfChecklist",
  components: {
    FormSelect: cr,
    FormRenderer: Kr
...
const se = /* @__PURE__ */ Y(Qr, [["render", Zr]]), Yr = {
  es: {
...
const es = {
  ...
  install(e, t = {}) {
    t.language && yt(t.language), e.use(es), e.component("VfChecklist", se);
  }
};
