...
const q = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, We = (e) => !G(e) && e !== q;
function ge() {
...
}, { allOwnKeys: r }), e), It = (e) => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e), qt = (e, t, n, r) => {
...
const en = (e) => {
  ...
  return n(e, 0);
}, tn = k("AsyncFunction"), nn = (e) => e && (Q(e) || F(e)) && F(e.then) && F(e.catch), Qe = ((e, t) => e ? setImmediate : t ? ((n, r) => (q.addEventListener("message", ({ source: s, data: i }) => {
  ...
  F(q.postMessage)
), rn = typeof queueMicrotask < "u" ? queueMicrotask.bind(q) : typeof process < "u" && process.nextTick || Qe, sn = (e) => e != null && F(e[le]), a = {
  isArray: $,
  isArrayBuffer: ze,
  isBuffer: K,
  isFormData: xt,
...
const at = (e) => {
  ...
  return e && !t;
}), qe = 64 * 1024, _e = lt && ct(() => a.isReadableStream(new Response("").body)), ae = {
  stream: _e && ((e) => e.body)
};
fe && ((e) => {
...
const pt = {
  ...
  mounted() {
    pt.getForms({ state: "enabled", moduleId: this.moduleId || void 0 }).then((e) => {
...
const lr = /* @__PURE__ */ Y(er, [["render", ar]]), cr = {
...
}, Nr = { class: "form-card" }, vr = { class: "form-header" }, Pr = { class: "form-title" }, Ur = { class: "form-subtitle" }, Br = { class: "section-title" }, Dr = { key: 0 }, Ir = { key: 0 }, qr = ["onUpdate:modelValue"], Mr = {
  key: 2,
  class: "table-wrapper"
  ...
  return E(), g("div", Nr, [
    ...
    (E(!0), g(U, null, B(i.orderedSections, (d) => (E(), g("div", {
      ...
      (E(!0), g(U, null, B(i.orderedInputs(d.inputs), (l) => (E(), g("div", {
        ...
        }, null, 8, ["options", "title-label", "input-id", "input-required", "answers", "onUpdate:answers"])) : I("", !0),
  ...
  methods: {
    loadForm(e) {
      pt.getFormById(e).then((t) => {
        this.forms.some((n) => n.instanceId === t.instanceId) || (this.forms.push(t), t.instanceId = this.forms.length + 1);
      }).catch((t) => console.error("Error cargando formulario:", t));
    },
    removeForm(e) {
      this.forms = this.forms.filter((t) => t.instanceId !== e);
    }
  }
...
function Xr(e, t, n, r, s, i) {
  ...
  return E(), g("div", Qr, [
    Et(o, {
      moduleId: n.moduleCode,
      lang: s.lang,
      onFormSelected: i.loadForm
    }, null, 8, ["moduleId", "lang", "onFormSelected"]),
    (E(!0), g(U, null, B(s.forms, (d) => (E(), Ee(c, {
      key: d.instanceId,
      "form-data": d,
      onRemoveForm: (l) => i.removeForm(d.instanceId)
